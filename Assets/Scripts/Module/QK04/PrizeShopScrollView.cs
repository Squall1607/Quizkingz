...
public class PrizeShopScrollView : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
	...
	void OnEnable(){
		InvokeRepeating ("NextScreen",3f,2f);
	}
	...
	//Use to play and stop auto scroll
	public void onClickItem(){
		myScrollView.GetComponent<PrizeShopScrollView> ().enabled = false;
	}

	public void returnShop(){
		myScrollView.GetComponent<PrizeShopScrollView> ().enabled = true;
	}
