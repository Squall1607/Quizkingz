...
public class ScrollSnapBasic : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
	...
	void OnEnable(){
		//Turn on horizontal to scroll the scroll view
		myScrollView.GetComponent<ScrollRect> ().horizontal = true;
		//Turn back scrollview to first page
//		SetPage (0);
		SetPageSelection(0);
	}
