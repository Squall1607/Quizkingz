...
public class ShopScrollVew_Controller : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
	...
	private void InitPageSelection() {
		...
		if (_showPageSelection) {
			...
			if (pageSelectionIcons == null || pageSelectionIcons.childCount != _pageCount) {
				...
				Debug.Log("pageSelectionIcons: "+ pageSelectionIcons.childCount);
