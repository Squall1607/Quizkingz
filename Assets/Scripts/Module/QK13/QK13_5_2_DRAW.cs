...
public class QK13_5_2_DRAW : BasePageController
{
    ...
    public GameObject GO11, GO01, GO10;
    ...
    void OnEnable()
    {
        ...
        if(QK7_2_Duel.lose == 0)
        {
            if (QK7_2_Duel.lose == 0 && QK7_2_Duel.win == 0)
            {
                lblYOU.text = "0";
                lblOPP.text = "0";
                GO11.SetActive(true);
