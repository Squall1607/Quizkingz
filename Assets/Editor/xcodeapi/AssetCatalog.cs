...
namespace UnityEditor.iOS.Xcode
{
    ...
    public class AssetCatalog
    {
        ...
        {
            var pathItems = PBX.UtilsPBX.SplitPath(relativePath).ToList();
        ...
        public AssetFolder OpenFolder(string relativePath)
        {
            if (relativePath == null)
                return root;
            var pathItems = PBX.UtilsPBX.SplitPath(relativePath);
        ...
        public AssetFolder OpenNamespacedFolder(string relativeBasePath, string namespacePath)
        {
            ...
            var pathItems = PBX.UtilsPBX.SplitPath(namespacePath);
            foreach (var pathItem in pathItems)
            {
                folder = folder.OpenFolder(pathItem);
    ...
    public abstract class AssetCatalogItem
    {
        ...
        public Dictionary<string, string> m_Properties = new Dictionary<string, string>();
        ...
        public JsonElementDict WriteInfoToJson(JsonDocument doc)
        {
   ...
   public abstract class AssetCatalogItemWithVariants : AssetCatalogItem
    {
		public List<VariantData> m_Variants = new List<VariantData>();
        public List<string> m_ODRTags = new List<string>();

        public AssetCatalogItemWithVariants(string name, string authorId) :
            base(name, authorId)
        {
        }
        ...
        public void AddVariant(VariantData newItem)
        {
            foreach (var item in m_Variants)
            {
        ...
        public void WriteODRTagsToJson(JsonElementDict info)
        {
        ...
        public void WriteRequirementsToJson(JsonElementDict item, DeviceRequirement req)
        {
