...
{   
	...
	public class IdentifierAST : ValueAST
    {
    ...
    //              ValueAST ','
    //              (empty)
	public class ArrayAST : ValueAST
    {
