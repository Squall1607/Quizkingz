...
namespace UnityEditor.iOS.Xcode.PBX
{
    ...
    {   
        public string guid;
        public PBXElementDict m_Properties = new PBXElementDict();
        ...
        public void SetPropertyList(string name, List<string> value)
        {
            if (value == null)
                m_Properties.Remove(name);
            else
        ...
        public static PropertyCommentChecker checkerData = new PropertyCommentChecker();
    ...
    public class PBXBuildFileData : PBXObjectData
    {
        ...
        public static PropertyCommentChecker checkerData = new PropertyCommentChecker(new string[]{
            "fileRef/*"
        });
   ...
   public class GUIDList : IEnumerable<string>
    ...
    public class PBXShellScriptBuildPhaseData : PBXObjectData
    {
        public GUIDList files;
    ...
    {
        public SortedDictionary<string, BuildConfigEntryData> entries = new SortedDictionary<string, BuildConfigEntryData>();
