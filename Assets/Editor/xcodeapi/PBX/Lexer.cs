...
namespace UnityEditor.iOS.Xcode.PBX
{
	...
	public class Lexer
    {
		...
		public void UpdateNewlineStats(char ch)
        {
            if (ch == '\n')
                line++;
        }
		...
		public void ScanString(Token tok)
        {
		...
		public void ScanQuotedString(Token tok)
        {
		...
		public void ScanMultilineComment(Token tok)
        {
		...
		public void ScanComment(Token tok)
        {
            tok.type = TokenType.Comment;
            tok.begin = pos;
            pos += 2;
		...
		public  void ScanOperator(Token tok)
        {
            switch (text[pos])
            {
		...
		public void ScanOperatorSpecific(Token tok, TokenType type)
        {
            tok.type = type;
            tok.begin = pos;
            pos++;
