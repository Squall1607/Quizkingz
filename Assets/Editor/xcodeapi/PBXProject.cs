...
namespace UnityEditor.iOS.Xcode
{
    ...
    public class PBXProject
    {
        ...
        {
            return UtilsPBX.CombinePaths(buildPath, "Unity-iPhone.xcodeproj/project.pbxproj");
        }
        ...
        {
            path = UtilsPBX.FixSlashesInPath(path);
            projectPath = UtilsPBX.FixSlashesInPath(projectPath);
            ...
            if (guid == null)
            {
                ...
                if (isFolderReference)
                    fileRef = PBXFileReferenceData.CreateFromFolderReference(path, UtilsPBX.GetFilenameFromPath(projectPath), tree);
                else
                    fileRef = PBXFileReferenceData.CreateFromFile(path, UtilsPBX.GetFilenameFromPath(projectPath), tree);
                PBXGroupData parent = CreateSourceGroup(UtilsPBX.GetDirectoryFromPath(projectPath));
        ...
        {
            sourceGroup = UtilsPBX.FixSlashesInPath(sourceGroup);
            ...
            var elements = PBX.UtilsPBX.SplitPath(sourceGroup);
        ...
        public void AddExternalProjectDependency(string path, string projectPath, PBXSourceTree sourceTree)
        {
            ...
            CreateSourceGroup(UtilsPBX.GetDirectoryFromPath(projectPath)).children.AddGUID(fileRef.guid);
        ...
        */
        ...
        {
            PBXNativeTargetData target = nativeTargets[targetGuid];
            filename = UtilsPBX.FixSlashesInPath(filename);
            projectPath = UtilsPBX.FixSlashesInPath(projectPath);
